...
if __name__ == '__main__':
    ...
    if resume:
        ...
        backbone = Backbone()
        net = SiameseITO(embedding_net=backbone, upscale=True, upscale_size=55)
    ...
    for e in range(epoch):
        ...
        if (e + 1) % 100 == 0:
            ...
            if total_score > best_score:
                ...
                torch.save(net, '../score=0.9206/best0106.pkl')
            torch.save(net, './train_model/SiamITO_last0106.pkl')
